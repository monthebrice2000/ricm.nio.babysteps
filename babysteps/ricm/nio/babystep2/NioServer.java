...
public class NioServer {
	...
	private void handleRead(SelectionKey key) throws IOException {
		...
		ReaderAutomata ra = new ReaderAutomata( sc, selector );
		ra.handleRead();


//		inBuffer = ByteBuffer.allocate(6);
...
//		System.out.println("NioServer received: " + msg);
	 ...
	 * 
	 * @param key of the channel on which data can be sent
	 */
	 ...
	 * Send data
	 * 
	 * @param sc of the channel on which data that should be sent
